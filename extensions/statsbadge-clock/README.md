...
Which one you got comes back as `weather.place`, so the Live panel shows it. Latitude and longitude reach a spot no name lands on, and win wherever both are set. Temperature reads in celsius or fahrenheit, wind in km/h, mph, m/s or knots.
