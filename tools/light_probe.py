...
# Something to light. A dark screen would understate what the panel contributes to its
# own reading.
...
def duty(fraction):
    """Return what the panel is lit at, for a 0-1 brightness.

    The panel resolves a byte of it and raises that to the power of 2.8 for the PWM level.
    """
